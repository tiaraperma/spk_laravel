...
@section('content')
  <main class="form-signin">
    <img class="mb-4" src="/asset/img/images.png" alt="Komputer" width="72" height="57">
    ...
    <form action="/" method="POST">
      ...
      <p class="mt-3 mb-3 text-muted">&copy; SPK pemilihan lokasi toko komputer{{ now()->year }}</p>
    </form>
  </main>
@endsection